...
public class ContentMngImpl implements ContentMng, ChannelDeleteChecker {
	...
	public Content getSide(Integer id, Integer siteId, Integer channelId,
			boolean next,Integer userId,Integer columnId,Integer topicId,Integer typeIds) {
		return dao.getSide(id, siteId, channelId, next, true,userId,columnId,topicId,typeIds);
	}
...
//		}
	...
	public int getTotalArticleNum(CmsUser user) {
		return  dao.getTotalArticleNum(user);
	}
	...
	public Pagination getPageForWorkArticle(String articleType, Integer sitId,Integer userId, int pageNo, int pageSize, int coulmnId) {
		return dao.getPageForWorkArticle(articleType,sitId,userId,pageNo,pageSize,coulmnId);
	}
}
