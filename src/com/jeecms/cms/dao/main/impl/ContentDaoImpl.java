	...
	private Finder byChannelIds(Integer[] channelIds, Integer[] typeIds,
		...
		if (option == 0 || len > 1) {
			...
			if(channelIds[0].toString().equals("102")){
				...
				//教师培训 9039
			}else if(channelIds[0].toString().equals("260")){
				//党群建设609227
			}else if(channelIds[0].toString().equals("177")){
				//政策研究674311
			}else{
			...
			String publishDates="";
			//446
			if(channelIds[0].toString().equals("446")){
				publishDate="2018";
				publishDates="2019";
			}
			...
			//院外信息
			//447
			if(channelIds[0].toString().equals("447")){
				publishDate="2018";
				publishDates="2019";
			}
			...
			if(StringUtils.isNotEmpty(publishDate)){
				...
				}else if(channelIds[0].toString().equals("447")){
					f.setParam("channelId", Integer.valueOf(channelIds[0].toString()));
				}else{
				...
				if(channelIds[0].toString().equals("102")){
					...
					//党群建设609227
                    f.append(" and bean.user.id=16741");
				}else if(channelIds[0].toString().equals("177")){
					//政策研究674311
                    f.append(" and bean.user.id=220894");
				}else{
					f.setParam("channelId", channelIds[0]);
				}
			}
