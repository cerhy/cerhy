...
ZoneAD_1.ZoneID      = 1;
ZoneAD_1.ZoneWidth   = 150;
ZoneAD_1.ZoneHeight  = 200;
ZoneAD_1.ShowType    = 1;
...
objAD.ADType         = 1;
objAD.ADName         = "链接内容";
objAD.ImgUrl         = "/r/cms/network/static/floatzone.jpg";
objAD.InstallDir     = "/";
objAD.ImgWidth       = 150;    
objAD.ImgHeight      = 200;
objAD.FlashWmode     = 0;
objAD.ADIntro        = "海南省教育研究培训院";
objAD.LinkUrl        = "http://www.cerhy.com/topic/5.jspx";
objAD.LinkTarget     = 1;
objAD.LinkAlt        = "海南省教育研究培训院";
objAD.Priority       = 1;
objAD.CountView      = 0;
objAD.CountClick     = 0;
objAD.ADDIR          = "AD";
